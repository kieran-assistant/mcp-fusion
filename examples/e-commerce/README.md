...
vurb insp --out stderr --demo

# NDJSON (for log aggregation)
Vurb.ts_LOG_FORMAT=json vurb insp --out stderr
```
...
| `npm test` | Run tests |
| `vurb insp --demo` | Inspector TUI with simulator |
| `vurb inspect` | Inspector TUI connected to server |
